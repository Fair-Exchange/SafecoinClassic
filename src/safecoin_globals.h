...
int32_t SAFECOIN_MININGTHREADS = -1,USE_EXTERNAL_PUBKEY,SAFECOIN_CHOSEN_ONE,ASSETCHAINS_SEED,SAFECOIN_ON_DEMAND,SAFECOIN_EXTERNAL_NOTARIES,SAFECOIN_PAX,SAFECOIN_EXCHANGEWALLET,SAFECOIN_REWIND,SAFECOIN_CONNECTING = -1,SAFECOIN_DEALERNODE,SAFECOIN_EXTRASATOSHI,ASSETCHAINS_FOUNDERS;
int32_t SAFECOIN_LASTMINED,prevSAFECOIN_LASTMINED,SAFECOIN_CCACTIVATE;
std::string NOTARY_PUBKEY,ASSETCHAINS_NOTARIES,ASSETCHAINS_OVERRIDE_PUBKEY,DONATION_PUBKEY,ASSETCHAINS_SCRIPTPUB;
uint8_t NOTARY_PUBKEY33[33],ASSETCHAINS_OVERRIDE_PUBKEY33[33],ASSETCHAINS_OVERRIDE_PUBKEYHASH[20],ASSETCHAINS_TXPOW;
bool VERUS_MINTBLOCKS,IS_SAFECOIN_NOTARY,SAFECOIN_PASSPORT_INITDONE,ASSETCHAINS_PUBLIC,ASSETCHAINS_PRIVATE,JUMBLR_PAUSE = true,SAFECOIN_INSYNC;
                ...
                if ( reward > 0 )
                {
                    ...
                    /* else */ if ( decay == SATOSHIDEN )
                    {
                        ...
                        if (sign < 0)
                        {
                            ...
                            cur_money += stepTriangle * pow(nSteps - 1, 2);
